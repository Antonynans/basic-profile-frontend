            ...
            <div className="card-body">
              ...
              <div className="direct-chat-contacts">
                <ul className="contacts-list">
                  <li>
                    <a href="/#">
                      <img className="contacts-list-img" alt="contacts-list" src="dist/img/user1-128x128.jpg" />
                  ...
                  <li>
                    <a href="/#">
                      <img className="contacts-list-img" alt="contacts-list" src="dist/img/user7-128x128.jpg" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Sarah Doe
                  ...
                  <li>
                    <a href="/#">
                      <img className="contacts-list-img" alt="contacts-list" src="dist/img/user3-128x128.jpg" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Nadia Jolie
                  ...
                  <li>
                    <a href="/#">
                      <img className="contacts-list-img" alt="contacts-list" src="dist/img/user5-128x128.jpg" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Nora S. Vans
                  ...
                  <li>
                    <a href="/#">
                      <img className="contacts-list-img" alt="contacts-list" src="dist/img/user6-128x128.jpg" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          John K.
                  ...
                  <li>
                    <a href="/#">
                      <img className="contacts-list-img" alt="contacts-list" src="dist/img/user8-128x128.jpg" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Kenneth M.
            ...
            <div className="card-header">
              ...
              <div className="card-tools">
                <ul className="pagination pagination-sm">
                  <li className="page-item"><a href="/#" alt="page-link" className="page-link">«</a></li>
                  <li className="page-item"><a href="/#" alt="page-link" className="page-link">1</a></li>
                  <li className="page-item"><a href="/#" alt="page-link" className="page-link">2</a></li>
                  <li className="page-item"><a href="/#" alt="page-link" className="page-link">3</a></li>
                  <li className="page-item"><a href="/#" alt="page-link" className="page-link">»</a></li>
                </ul>
              </div>
            </div>
